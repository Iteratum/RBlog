  ...
  return (
    <div className=' bg-gray-400'>
      <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl place-items-center lg:place-items-center font-mono tracking-tight sm:text-6xl md:text-8xl lg:text-8xl">News, tips, blogs & insights</h2>
